...
function marginHeader() {
  ...
  const userConstents = document.querySelectorAll('.userConstent');
  ...
  if (window.innerWidth < 1280) {
    ...
    userConstents.forEach((constent) => {
      constent.style.top = `${header.offsetHeight}px`;
      constent.style.minHeight = `calc(100vh - ${header.offsetHeight}px)`;
    });
...
export { depositAmmount as a, depositCopy as b, menuHeaderMobile as c, depositSteps as d, gsapWithCSS as g, marginHeader as m, popUpSaldo as p };
//# sourceMappingURL=menuHeaderMobile-e6247847.js.map
