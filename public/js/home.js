(function () {
  ...
  function omit$1(object, keys) {
    toArray$3(keys || ownKeys$2(object)).forEach(function (key) {
      delete object[key];
    });
  }
  ...
  function State(initialState) {
    ...
    function is(states) {
      return includes(toArray$3(states), state);
    }
  ...
  function Slides(Splide2, Components2, options) {
    ...
    function filter(matcher) {
      return Slides2.filter(isFunction(matcher) ? matcher : function (Slide2) {
        return isString$1(matcher) ? matches$1(Slide2.slide, matcher) : includes(toArray$3(matcher), Slide2.index);
      });
    }
  ...
  */
  ...
  var Tween = /*#__PURE__*/function (_Animation2) {
    ...
    function Tween(targets, vars, position, skipInherit) {
      ...
      var _this3$vars = _this3.vars,
          ...
          parsedTargets = (_isArray(targets) || _isTypedArray(targets) ? _isNumber(targets[0]) : "length" in vars) ? [targets] : toArray$2(targets),
          tl,
          i,
          copy,
          l,
  ...
  var _gsap = {
    ...
    getProperty: function getProperty(target, property, unit, uncache) {
      _isString(target) && (target = toArray$2(target)[0]); //in case selector text or an array is passed in
