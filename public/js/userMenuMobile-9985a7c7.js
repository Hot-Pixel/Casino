...
function popUpSaldo() {
    ...
    if(window.innerWidth < 1280) {
      btn.addEventListener("click", () => {
        gsapWithCSS
          ...
          .to(popUpMenu, { opacity: 1, transform: "translateY(0)", duration: 0.4 });
      });
    } else {
      btn.addEventListener("click", () => {
        gsapWithCSS
  ...
  popUpCloseBtn.addEventListener("click", () => {
    if(window.innerWidth < 1280) {
      gsapWithCSS
      .timeline()
      .to(popUpMenu, { opacity: 0, transform: "translateY(100%)", duration: 0.3 })
...
export { depositAmmount as a, depositCopy as b, menuHeaderMobile as c, depositSteps as d, gsapWithCSS as g, marginHeader as m, popUpSaldo as p, userMenuMobile as u };
//# sourceMappingURL=userMenuMobile-9985a7c7.js.map
