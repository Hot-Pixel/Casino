(function (flatpickr, es_js, rangePlugin) {
  'use strict';
  ...
  */
  ...
  function calendarHistory() {
    flatpickr__default["default"]("#startDate", {
      locale: 'es',
      plugins: [new rangePlugin__default["default"]({ input: "#endDate" })],
      dateFormat: "d-m-Y",
      disableMobile: "true"
    });
  }
